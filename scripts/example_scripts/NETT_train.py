...
from LION.optimizers.supervised_learning import NETTSolver
...
validation_fname = savefolder.joinpath("NETT_ConvNet_min_val.pt")
...
model = NETT_ConvNet(experiment.geo).to(device)
...
#%% Train
# create solver
solver = NETTSolver(model, optimiser, loss_fcn, verbose=True)
